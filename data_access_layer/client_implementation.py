...
class ClientDataImplementation(ClientDataInterface):
    ...
    def __init__(self):
        ...
        self.mekio_client = ClientDataInit("Mekio", "Nefta")
        self.mekio_client_id = self.mekio_client.client_id

        self.salvador_client = ClientDataInit("Salvador", "Veluvaza")
        self.salvador_client_id = self.salvador_client.client_id
        self.salvador_account_one = AccountDataInit(self.salvador_client_id, 50)
        self.salvador_account_one_id = self.salvador_account_one.account_id
        self.salvador_account_two = AccountDataInit(self.salvador_client_id, 100)
        ...
        self.luken_client = ClientDataInit("Luken", "VonTelan")
        self.luken_client_id = self.luken_client.client_id

        self.zandel_client = ClientDataInit("Zandel", "Horris")
        self.zandel_client_id = self.zandel_client.client_id
        self.zandel_account = AccountDataInit(self.zandel_client_id, 50)
        ...
        self.isaac_client = ClientDataInit("Isaac", "Daurcour")
        self.isaac_client_id = self.isaac_client.client_id

        self.hamel_client = ClientDataInit("Hamel", "Bergstrom")
        self.hamel_client_id = self.hamel_client.client_id
        self.hamel_account = AccountDataInit(self.hamel_client_id, 0)
    ...
    def transfer_between_accounts(self, client_id: str, account_from_id: str, account_to_id: str, transfer_amount: float) -> bool:
        account_one: AccountDataInit
        account_two: AccountDataInit
